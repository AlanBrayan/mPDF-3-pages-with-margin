...
<html lang="en">
   ...
   <body style="font-family: timesnewroman;">
      ...
      <table style="width:125%">
         <tr style="width=100%">
            <th colspan="2"  style="text-align: center;   background-color: rgb(156, 156, 156) ;  font-size: 11pt;" >
               <div><br></div>
               <div><br></div>
               CONTRATOINDIVIDUAL DE TRABAJO POR TIEMPO DETERMINADO
            </th>
         </tr>
      </table>
      <div id="light-table1">
      ...
      <div id="light-table3">
         <div id="leftdivcontainer" class="clearfix">
            ...
            <div style="font-family: timesnewroman;" style="font-size: 7.4pt" class="leftdiv38" style="text-align: justify;">
               La celebración del presente contrato se justifica plenamente, en virtud de que en el Centro de Atención 
               Telefónica del Gobierno del Estado de México de la Dirección General de Innovación, no existe personal que 
               pueda satisfacer las necesidades objeto del mismo. 
            </div>
         </div>
      </div>
      <div id="light-table3">
      <div id="leftdivcontainer" class="clearfix">
         ...
         <div style="font-family: timesnewroman;" style="font-size: 7.4pt" class="leftdiv40" style="text-align: justify;">
            Que señala como su domicilio para los efectos del presente contrato, el ubicado en Ignacio Allende Sur Núm. 
            415, 3er piso. Colonia Francisco Murguía, C.P. 50130, en la ciudad de Toluca de Lerdo, México.            
         </div>
      </div>
      <br><br><br>
      <div id="light-table2">
